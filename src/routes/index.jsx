...
function Index() {
    ...
    return (
        <>
            <SEO 
                title="Safa Demirkan | Sr. Software Engineer in Test"
                description="Senior Software Engineer in Test specializing in test automation, CI/CD pipelines, and innovative solutions. Explore my portfolio and projects."
                keywords="software testing, test automation, QA engineer, software development, CI/CD"
            />
