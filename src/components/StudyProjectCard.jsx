...
export const StudyProjectCard = ({ project }) => {
            ...
            <div className='flex flex-col p-6 h-full bg-black/30 backdrop-blur-sm rounded-lg border border-teal-500/20 hover:scale-[1.02] transition-all duration-300 animate-fade-in'>
                <div className="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <span className='text-sm px-2 py-1 rounded-full bg-teal-500/20 text-teal-100'>
                            {project.category}
                        </span>
                    </div>
                ...
                <div className='flex-1 flex flex-col'>
                    ...
                    >
                        View Code <FontAwesomeIcon icon={faExternalLink} className="ml-2" />
                    </a>
                </div>
            </div>
